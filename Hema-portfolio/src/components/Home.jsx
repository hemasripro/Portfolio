		...
		<div className='area relative z-0 bg-black w-screen h-screen'>
			...
			<div className='hero relative h-[calc(100vh)] flex justify-center items-center text-white' id='hero'>
				<div className='pt-4 h-36 backdrop-blur-sm rounded-3xl'>
					...
					<p className='mt-3 text-xl'>I am passionate about designing and developing scalable and optimized backend systems, leveraging my expertise in Python, Java, data structures, and full-stack web development.</p>
				</div>      
			</div>
			<Footer/>
		</div>	
